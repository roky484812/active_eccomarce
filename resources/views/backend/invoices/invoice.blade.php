	...
	<div>
		...
		<div style="padding: 1rem;padding-bottom: 0">
            <table>
				...
				<tr>
                     <td class="gry-color small">{{ $shipping_address->address }}{{--, {{ $shipping_address->city ?? '' }},  {{ json_decode($order->shipping_address)->state ?? '' }} {{ $shipping_address->postal_code ?? '' }}, {{ $shipping_address->country ?? '' }} --}}</td>
                </tr>
