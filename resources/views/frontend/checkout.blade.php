                                    ...
                                    <div class="card-body" id="payment_info">
                                        ...
                                        <div class="pt-2rem fs-14">
                                            <label class="aiz-checkbox">
                                                <input type="checkbox" checked required id="agree_checkbox" onchange="stepCompletionPaymentInfo()">
...
@section('script')
    <script type="text/javascript">
        ...
        function stepCompletionDeliveryInfo() {
            ...
            var btnDisable = true;
            var allOk = false;
            var content = $('#delivery_info [required]:checked');
            if (content.length > 0) {
        ...
        function updateDeliveryInfo(shipping_type, type_id, user_id) {
            $('.aiz-refresh').addClass('active');
